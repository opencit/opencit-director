...
INSERT INTO mw_policy_template(id, name, deployment_type, content, active, deployment_type_identifier,policy_type)
    VALUES ('1', 'Bare Metal (NV)', 'BareMetal', '', true, 'NV', 'Manifest');

INSERT INTO mw_policy_template(id, name, deployment_type, content, active, deployment_type_identifier,policy_type)
    VALUES ('2', 'Bare Metal (V)', 'BareMetal', '<?xml version="1.0" ?><Measurements DigestAlg="sha1"><File Path="/opt/trustagent/bin/functions"/><File Path="/opt/trustagent/bin/aikquote"/><FilePath="/opt/trustagent/bin/module_analysis.sh"/><File Path="/opt/trustagent/bin/NIARL_TPM_Module"/><File Path="/opt/trustagent/bin/openssl.sh"/><FilePath="/opt/trustagent/bin/tagent.sh"/><File Path="/opt/trustagent/bin/tpm_bindaeskey"/><File Path="/opt/trustagent/bin/tpm_createkey"/><FilePath="/opt/trustagent/bin/tpm_signdata"/><File Path="/opt/trustagent/bin/tpm_unbindaeskey"/><File Path="/opt/trustagent/bin/tagent"/><FilePath="/opt/trustagent/bin/tpm_nvdefine"/><File Path="/opt/trustagent/bin/tpm_nvinfo"/><File Path="/opt/trustagent/bin/tpm_nvread"/><FilePath="/opt/trustagent/bin/tpm_nvrelease"/><File Path="/opt/trustagent/bin/tpm_nvwrite"/>    <File Path="/opt/tbootxm/bin/configure_host.sh"/><FilePath="/opt/tbootxm/bin/functions.sh"/><File Path="/opt/tbootxm/bin/generate_initrd.sh"/><File Path="/opt/tbootxm/bin/measure_host"/><FilePath="/opt/tbootxm/bin/tpmextend"/><File Path="/opt/tbootxm/bin/verifier"/><File Path="/opt/vrtm/functions.sh"/><File Path="/opt/vrtm/vrtmcore"/><File Path="/opt/vrtm/vrtm_listener"/><File Path="/opt/vrtm/vrtm_proxy"/><File Path="/opt/vrtm/vrtm-uninstall.sh"/><FilePath="/opt/policyagent/bin/functions.sh"/><File Path="/opt/policyagent/bin/libvirt-activate.sh"/><File Path="/opt/policyagent/bin/policyagent.sh"/><File Path="/opt/policyagent/bin/policyagent.bat"/></Measurements>', true, 'V', 'Manifest');

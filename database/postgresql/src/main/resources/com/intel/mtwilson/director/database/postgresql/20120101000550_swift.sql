...
ALTER TABLE MW_IMAGE ALTER COLUMN CREATED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_IMAGE ALTER COLUMN EDITED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_TRUST_POLICY ALTER COLUMN CREATED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_TRUST_POLICY ALTER COLUMN EDITED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_IMAGE_UPLOAD ALTER COLUMN DATE TYPE TIMESTAMP;
ALTER TABLE MW_POLICY_UPLOAD ALTER COLUMN DATE TYPE TIMESTAMP;
ALTER TABLE MW_TRUST_POLICY_DRAFT ALTER COLUMN CREATED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_TRUST_POLICY_DRAFT ALTER COLUMN EDITED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_HOST ALTER COLUMN CREATED_DATE TYPE TIMESTAMP;
ALTER TABLE MW_HOST ALTER COLUMN EDITED_DATE TYPE TIMESTAMP;

...
public class KmsClientTest {
	...
	public void testKmsPassword() throws Exception {
		...
		properties.setProperty("tls.policy.certificate.sha1",
				"82fe5d82a8725529a5110584d3b0111172a7572c");
		...
		keys.createKey(createKeyRequest);
		// Request server to transfer the new key to us (encrypted)
		// decrypt the requested key
		// RsaPublicKeyProtectedPemKeyEnvelopeOpener opener = new
		// RsaPublicKeyProtectedPemKeyEnvelopeOpener(wrappingKeyCertificate.getPrivateKey(),
		// kmsLoginBasicUsername);
		// SecretKey secretKey = (SecretKey)
		// opener.unseal(Pem.valueOf(transferKeyPemResponse));

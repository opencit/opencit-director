...
public class MHUtilityOperation {
    ...
    private String mhJarLocation = "/opt/trustdirector/java/client-0.1-SNAPSHOT-with-dependencies.jar";
    ...
    private String KMSServerIP = ConfigProperties.getProperty(Constants.KMS_SERVER_IP);

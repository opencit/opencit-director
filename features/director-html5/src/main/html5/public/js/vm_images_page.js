...
$(document)
    .ready(
        function() {
            ...
            $("#vm_images_grid_page").load("/v1/html5/public/director-html5/vm_images_grid_page.html");
...
function goToCreatePolicyWizard() {
    ...
    $("#create_policy_wizard_").load("/v1/html5/public/director-html5/create_policy_wizard.html");

...
public class ImageTransferTask implements Runnable {
    ...
    private final ImageStoreRequest imageStoreRequest;
    private final GlanceRsClient glanceRsClient;

    public ImageTransferTask(ImageStoreRequest imageStoreRequest, GlanceRsClient glanceRsClient) {
        this.imageStoreRequest = imageStoreRequest;

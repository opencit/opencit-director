...
public class GlanceTest {
	...
	public void glanceTest() throws DbException {
			...
			configuration.put(Constants.GLANCE_KEYSTONE_PUBLIC_ENDPOINT, "http://10.35.35.169:5000");
		 	configuration.put(Constants.GLANCE_API_ENDPOINT, "http://10.35.35.169:9292");
	        ...
	        configuration.put(Constants.GLANCE_DOMAIN_NAME,"default");
	        configuration.put(Constants.GLANCE_ID,uuid);
	        configuration.put(Constants.KEYSTONE_VERSION,Constants.VERSION_V3);
	        configuration.put(com.intel.director.constants.Constants.NAME, "default");
	        ...
	        mp.put(com.intel.director.common.Constants.UPLOAD_TO_IMAGE_STORE_FILE, "C:/Aakash/APITMStudy.txt");
...
/*		try {
			...
			configuration1.put(Constants.GLANCE_KEYSTONE_PUBLIC_ENDPOINT, "http://10.35.35.169:5000");
		 	configuration1.put(Constants.GLANCE_API_ENDPOINT, "http://10.35.35.169:9292");
	        ...
	        configuration1.put(Constants.GLANCE_TENANT_NAME,"default");

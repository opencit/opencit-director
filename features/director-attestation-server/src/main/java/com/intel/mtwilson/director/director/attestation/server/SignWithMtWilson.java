...
public class SignWithMtWilson {
    ...
    public SignWithMtWilson() throws IOException {
        mtWilsonIP = getConfiguration().get("mtwilson.server");
        mtWilsonPort = getConfiguration().get("mtwilson.server.port");
        mtWilsonUserName = getConfiguration().get("mtwilson.username");
        mtWilsonPassword = getConfiguration().get("mtwilson.password");
    }

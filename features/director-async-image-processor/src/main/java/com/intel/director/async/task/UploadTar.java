 ...
 * @author GS-0681
 */
public class UploadTar extends GenericUpload {
	public UploadTar() throws DirectorException {
		super();
	}
	...
	public boolean runUploadTarTask() {
		...
		/// This is the tag in image metatdata to be uploaded to glance showing details about trust policy location

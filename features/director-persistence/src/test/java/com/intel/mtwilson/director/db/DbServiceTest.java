...
public class DbServiceTest {
	...
	public void integrationTest() throws DbException {
		...
		/*
		 * removeImageupload(); removeAllImagesEntries();
		 * removeAllImageStoreSettingsEntries();
		 */
	}
	...
	public void testMiscellaneous() throws DbException {
		...
		TrustPolicy trustPolicy = dBServiceImpl.fetchActivePolicyForImage(imageId);
		TrustPolicyDraft trustPolicyDraft = dBServiceImpl
				.fetchPolicyDraftForImage(imageId);
		List<ImageStoreUploadTransferObject> imageUploadList = dBServiceImpl
				.fetchPolicyUploadsForImage(imageId);
		System.out.println("trustPolicy::" + trustPolicy);
		Assert.assertTrue("fetchPolicyForImage fail", trustPolicy != null);
	...
	public void testImageStoreSettings() throws DbException {
		ImageStoreSettings imageStoreSettings = new ImageStoreSettings(
				"Glance", "GlanceProviderClass");
		ImageStoreSettings imageStoreSettingsCreated = dBServiceImpl
				.saveImageStoreSettings(imageStoreSettings);
		Assert.assertTrue("ImageStoreSettings create fail",
				imageStoreSettingsCreated.getId() != null);
		ImageStoreSettings imageStoreSettingsfetched = dBServiceImpl
				.fetchImageStoreSettingsByName("Glance");
		Assert.assertTrue("fetchImageStoreSettings name",
				imageStoreSettingsCreated.getId() == imageStoreSettingsfetched
						.getId());
	...
	public void testImageDao() throws DbException {
		...
		for (int i = 0; i < imgAttributesList.size(); i++) {
			persistedImgAttributesList.add(dBServiceImpl
					.saveImageMetadata(imgAttributesList.get(i)));
		}
		...
		searchFilter
				.setUploadCriteria(SearchImageByUploadCriteria.NOT_UPLOADED);
		...
		searchFilterPolicyCriteria
				.setPolicyCriteria(SearchImageByPolicyCriteria.WITH);
		List<ImageInfo> searchImageListPolicyCriteria = dBServiceImpl
				.fetchImages(searchFilterPolicyCriteria, imgOrderBy);
		Assert.assertTrue(
		...
		List<ImageInfo> searchImagePaginatedList = dBServiceImpl.fetchImages(
				searchFilter, imgOrderBy, 2, 2);
	...
	public void removeAllImagesEntries() throws DbException {
		...
		List<ImageInfo> imgInfoList = dBServiceImpl.fetchImages(null);
	 ...
	 * 
	 * List<TrustPolicy> policiesList = dBServiceImpl .fetchPolicies(null); for
	 * (TrustPolicy policy : policiesList) {
	...
	public void testPolicyDao() throws DbException {
		try {
			...
			TrustPolicy trustPolicy1 = new TrustPolicy(createdUserId,
					sevenDaysBackDate, createdUserId, sevenDaysBackDate,
					"trustPolicy1desc", "<abc>TrustPolicy xml1 field</abc>",
					"TrustPolicy1_" + sevenDaysBackDate,
					persistedImgAttributesList.get(0));
			deleteTrustPoliciesList.add(trustPolicy1);
			TrustPolicy trustPolicyCreated = dBServiceImpl
					.savePolicy(trustPolicy1);
			Assert.assertTrue("Create operation fail",
					trustPolicyCreated.getId() != null);
			...
			TrustPolicy trustPolicyRetrieved = dBServiceImpl
					.fetchPolicyById(trustPolicyId);
			System.out.println("Image Name::"
					+ trustPolicyRetrieved.getImgAttributes().getImage_name());
			System.out.println("trustPolicyRetrieved.getDescription()::"
					+ trustPolicyRetrieved.getDescription());
			Assert.assertTrue("Update operation fail", (trustPolicyRetrieved
					.getDescription().equals("Updated Description")));
			List<TrustPolicy> trustPoliciesList = new ArrayList<TrustPolicy>();
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"trustPolicy2desc", "<abc>TrustPolicy xml2 field</abc>",
					"TrustPolicy2_" + sevenDaysBackDate,
					persistedImgAttributesList.get(1)));
			trustPoliciesList.add(new TrustPolicy(createdUserId,
					threeDaysBackDate, createdUserId, threeDaysBackDate,
					"trustPolicy3desc", "<abc>TrustPolicy xml3 field</abc>",
					"TrustPolicy3_" + sevenDaysBackDate,
					persistedImgAttributesList.get(2)));
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					oneDaysBackDate, createdUserId2, oneDaysBackDate,
					"trustPolicy4desc", "<abc>TrustPolicy xml4 field</abc>",
					"TrustPolicy4_" + sevenDaysBackDate,
					persistedImgAttributesList.get(3)));
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"trustPolicy5desc", "<abc>TrustPolicy xml5 field</abc>",
					"TrustPolicy5_" + sevenDaysBackDate,
					persistedImgAttributesList.get(4)));
			trustPoliciesList.add(new TrustPolicy(createdUserId,
					threeDaysBackDate, createdUserId, threeDaysBackDate,
					"trustPolicy6desc", "<abc>TrustPolicy xml6 field</abc>",
					"TrustPolicy6_" + sevenDaysBackDate,
					persistedImgAttributesList.get(5)));
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"trustPolicy7desc", "<abc>TrustPolicy xml7 field</abc>",
					"TrustPolicy7_" + sevenDaysBackDate,
					persistedImgAttributesList.get(6)));
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"trustPolicy8desc", "<abc>TrustPolicy xml8 field</abc>",
					"TrustPolicy8_" + sevenDaysBackDate,
					persistedImgAttributesList.get(7)));
			trustPoliciesList.add(new TrustPolicy(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"trustPolicy9desc", "<abc>TrustPolicy xml9 field</abc>",
					"TrustPolicy9_" + sevenDaysBackDate,
					persistedImgAttributesList.get(8)));
			...
			System.out
					.println("#######################Search Trust policies############"
							+ searchPolicyList.size());

			for (TrustPolicy tp : searchPolicyList) {
				System.out.println("### trust policy::" + tp);
				System.out.println("### searchPolicyList imageName::"
						+ tp.getImgAttributes().getImage_name());
			}
			Assert.assertTrue(
			...
			int serachTotalCount = dBServiceImpl
					.getTotalPoliciesCount(trustPolicyFilter);
			System.out
					.println("#######################totalCount_ trust policy######::"
							+ totalCount);
			Assert.assertTrue("getTotalPoliesCount() method fail",
					totalCount == 9);
			...
			List<TrustPolicy> searchPolicyFilterByImageList = dBServiceImpl
					.fetchPolicies(trustPolicyFilterByImage, tpOrderByImage);
			for (TrustPolicy tp : searchPolicyFilterByImageList) {
				System.out
						.println("### trustPolicy after searchPolicyFilter orderByImageList desc::"
								+ tp);
			}
	...
	public void testPolicyDraftDao() throws DbException {
		try {
			...
			TrustPolicyDraft trustPolicyDraft1 = new TrustPolicyDraft(
					createdUserId, sevenDaysBackDate, createdUserId,
					sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml1 field</abc>",
					"TrustPolicyDraft1_" + sevenDaysBackDate,
					persistedImgAttributesList.get(0));
			deleteTrustPoliciesList.add(trustPolicyDraft1);
			TrustPolicyDraft trustPolicyDraftCreated = dBServiceImpl
					.savePolicyDraft(trustPolicyDraft1);
			Assert.assertTrue("Create operation fail",
					trustPolicyDraftCreated.getId() != null);

			List<TrustPolicyDraft> trustPoliciesDraftList = new ArrayList<TrustPolicyDraft>();
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml2 field</abc>",
					"TrustPolicyDraft2_" + sevenDaysBackDate,
					persistedImgAttributesList.get(1)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId,
					threeDaysBackDate, createdUserId, threeDaysBackDate,
					"<abc>TrustPolicyDraft xml3 field</abc>",
					"TrustPolicyDraft3_" + sevenDaysBackDate,
					persistedImgAttributesList.get(2)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					oneDaysBackDate, createdUserId2, oneDaysBackDate,
					"<abc>TrustPolicyDraft xml4 field</abc>",
					"TrustPolicyDraft4_" + sevenDaysBackDate,
					persistedImgAttributesList.get(3)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml5 field</abc>",
					"TrustPolicyDraft5_" + sevenDaysBackDate,
					persistedImgAttributesList.get(4)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId,
					threeDaysBackDate, createdUserId, threeDaysBackDate,
					"<abc>TrustPolicyDraft xml6 field</abc>",
					"TrustPolicyDraft6_" + sevenDaysBackDate,
					persistedImgAttributesList.get(5)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml7 field</abc>",
					"TrustPolicyDraft7_" + sevenDaysBackDate,
					persistedImgAttributesList.get(6)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml8 field</abc>",
					"TrustPolicyDraft8_" + sevenDaysBackDate,
					persistedImgAttributesList.get(7)));
			trustPoliciesDraftList.add(new TrustPolicyDraft(createdUserId2,
					sevenDaysBackDate, createdUserId2, sevenDaysBackDate,
					"<abc>TrustPolicyDraft xml9 field</abc>",
					"TrustPolicyDraft9_" + sevenDaysBackDate,
					persistedImgAttributesList.get(8)));
			...
			tpOrderBy
					.setTrustPolicyDraftFields(TrustPolicyDraftFields.CREATED_DATE);

			tpOrderBy.setOrderBy(OrderByEnum.DESC);
			List<TrustPolicyDraft> searchPolicyDraftList = dBServiceImpl
			...
			for (TrustPolicyDraft tpd : searchPolicyDraftList) {
				...
				System.out.println("### searchPolicyDraftList imageName::"
						+ tpd.getImgAttributes().getImage_name());
			}
			Assert.assertTrue("fetchPolicyDrafts(searchFilter, OrderBy) fail",
					(searchPolicyDraftList.size() == 6));

			int totalCount = dBServiceImpl.getTotalPoliciesCount();

			int serachTotalCount = dBServiceImpl
					.getTotalPolicyDraftsCount(trustPolicyDraftFilter);
			System.out
					.println("#######################totalCount_ trust policy######::"
							+ totalCount);
			Assert.assertTrue("getTotalPolicyDraftsCount() method fail",
					totalCount == 9);
			Assert.assertTrue(
					"getTotalPolicyDraftsCount(searchFilter) method fail",
					serachTotalCount == 6);
			...
			tpOrderByImage
					.setTrustPolicyDraftFields(TrustPolicyDraftFields.IMAGE_NAME);

			tpOrderByImage.setOrderBy(OrderByEnum.DESC);

			List<TrustPolicyDraft> searchPolicyDraftFilterByImageList = dBServiceImpl
					.fetchPolicyDrafts(trustPolicyDraftFilterByImage,
							tpOrderByImage);
			for (TrustPolicyDraft tpd : searchPolicyDraftFilterByImageList) {
				System.out
						.println("### trustPolicyDraft after searchPolicyDraftFilter orderByImageList desc::"
								+ tpd);
			}
	...
	public void testImageUploadDao() throws DbException {
		...
		for(ImageStoreUploadTransferObject imgU: imageUploadList){
			...
			imgUpload1 = new ImageStoreUploadTransferObject(
					"http://imageuri1", sevenDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId,
					persistedImgAttributesList.get(0));

			ImageStoreUploadTransferObject imageStoreUploadCreated1 = dBServiceImpl
					.saveImageUpload(imgUpload1);
			Assert.assertTrue("Create image upload operation fail",
					imageStoreUploadCreated1.getId() != null);

			imageUploadList = new ArrayList<ImageStoreUploadTransferObject>();
			imageUploadList.add(new ImageStoreUploadTransferObject(
					"http://imageuri2", sevenDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId2,
					persistedImgAttributesList.get(1)));
			imageUploadList.add(new ImageStoreUploadTransferObject(
					"http://imageuri3", threeDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId2,
					persistedImgAttributesList.get(2)));
			imageUploadList.add(new ImageStoreUploadTransferObject(
					"http://imageuri4", sevenDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId2,
					persistedImgAttributesList.get(3)));
			imageUploadList.add(new ImageStoreUploadTransferObject(
					"http://imageuri5", oneDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId2,
					persistedImgAttributesList.get(4)));
			imageUploadList.add(new ImageStoreUploadTransferObject(
					"http://imageuri6", sevenDaysBackDate, "C:/temp", "edfd",
					"ACTIVE", 2048L, 1024L, createdUserId2,
					persistedImgAttributesList.get(5)));
			...
			List<ImageStoreUploadTransferObject> searcImgList = dBServiceImpl
					.fetchImageUploads(imgUpFilter, imgOrder);
			...
			for (ImageStoreUploadTransferObject tpd : searcImgList) {
				...
				System.out.println("### ImageStoreUploadOrderBy imageName::"
						+ tpd.getImg().getImage_name());
			}
			Assert.assertTrue("fetchImageUploads(searchFilter, OrderBy) fail",
					(searcImgList.size() != 0));

			int totalCount = dBServiceImpl.getTotalImageUploadsCount();

			int serachTotalCount = dBServiceImpl
					.getTotalImageUploadsCount(imgUpFilter);
			System.out
					.println("#######################totalCount_ trust policy######::"
							+ totalCount);
			System.out
					.println("#######################serachTotalCount######::"
							+ serachTotalCount);
			Assert.assertTrue("getTotalImageUploadsCount() method fail",
					totalCount == 6);
			Assert.assertTrue(
					"getTotalImageUploadsCount(searchFilter) method fail",
					serachTotalCount == 4);
